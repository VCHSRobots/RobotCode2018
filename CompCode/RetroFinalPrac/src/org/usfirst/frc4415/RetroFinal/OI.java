...
public class OI {
    ...
    public OI() {
        ...
        telescopeDownButton.whileHeld(new TelescopeClimbDownGroup());
        ...
        telescopeUpButton.whileHeld(new TelescopeClimbUpGroup());
        ...
        scaleGroupButton.whenPressed(new ScaleGroup());
        ...
        wheelInButton.whenPressed(new WheelIn());
        wheelOutButton = new JoystickButton(driverJoystick, 6);
        wheelOutButton.whenPressed(new WheelOut());
