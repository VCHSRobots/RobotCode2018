...
public class Robot extends TimedRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        chooser.addDefault("Auto Do Nothing", new AutoDoNothingCommand());
        chooser.addObject("Auto Drive Forward Command", new AutoDriveForwardCommand());
        
        //chooser.addObject("Auto LeftSwitch Command", new AutoLeftSwitchCommandGroup());
        //chooser.addObject("Auto LeftScale Command", new AutoLeftScaleCommandGroup());
        
        //chooser.addObject("Auto MiddleSwitch Command", new AutoMiddleSwitchCommandGroup());
        
        //chooser.addObject("Auto RightSwitch Command", new AutoRightSwitchCommandGroup());
        //chooser.addObject("Auto RightScale Command", new AutoRightScaleCommandGroup());
    ...
    public void autonomousPeriodic() {
        ...
        SmartDashboard.putNumber("Auto DriveTrain Encoder Ticks: ", Robot.driveTrainPID.getEncoder());
        ...
        SmartDashboard.putNumber("ddkfjasldfjladfjlsdkfjlsdkj: ", Robot.driveTrainPID.getEncoder());
    ...
    public void teleopInit() {
        ...
        driveTrainPID.disable();
        driveTrainPID.resetEncoder();
        //wedgeArmPID.resetEncoder();
        //clawPID.wristRestartUp();
        telescopePID.disable();
    ...
    public void teleopPeriodic() {
        ...
        SmartDashboard.putNumber("Claw Encoder Ticks: ", Robot.clawPID.getEncoder());
        SmartDashboard.putNumber("DriveTrain Encoder Ticks: ", Robot.driveTrainPID.getEncoder());
        SmartDashboard.putNumber("Telescope Encoder Ticks: ", Robot.telescopePID.getEncoder());
        SmartDashboard.putNumber("WedgeArm Encoder Ticks: ", Robot.wedgeArmPID.getEncoder());
        SmartDashboard.putBoolean("Telescope Limit Switch: ", Robot.telescopePID.getLimitSwitch1());
        SmartDashboard.putBoolean("Claw Limit Switch: ", Robot.clawPID.getLimitSwitch());
