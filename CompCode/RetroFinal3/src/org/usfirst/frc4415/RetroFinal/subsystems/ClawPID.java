...
public class ClawPID extends PIDSubsystem {
    ...
    private final WPI_TalonSRX wheelMotor2 = RobotMap.clawPIDwheelMotor2;
    ...
    public ClawPID() {
        ...
        super("ClawPID", -0.07, 0.0, 0.0);  // was .3 for P  // was .15
    ...
    public void wristRestartUp() {
    	while (Robot.clawPID.getLimitSwitch() == true) {
