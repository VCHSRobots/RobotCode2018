 ...
 *
 */
public class AutoLeftScaleCommandGroup extends CommandGroup {
	
	String gameData;

	
    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public AutoLeftScaleCommandGroup() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    	...
    	if (gameData.length() > 0) {
    		...
    		if (gameData.charAt(1) == 'L') {
    			...
    			addSequential (new LeftSwerveWideCommandGroup());
    		...
    		if (gameData.charAt(1) == 'R') {
    			//Robot.driveTrainPID.driveForwardGyroSetpoint(500);
