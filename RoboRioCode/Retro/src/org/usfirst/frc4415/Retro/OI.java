...
public class OI {
    ...
    public OI() {
        ...
        retroWedgeArmDownButton2 = new JoystickButton(retroStick2, 2);
        retroWedgeArmDownButton2.whileHeld(new RetroWedgeArmDown());
        retroWedgeArmUpButton2 = new JoystickButton(retroStick2, 1);
        ...
        retroWedgeArmDownButton = new JoystickButton(retroStick, 4);
        retroWedgeArmDownButton.whileHeld(new RetroWedgeArmDown());
        retroWedgeArmUpButton = new JoystickButton(retroStick, 3);
